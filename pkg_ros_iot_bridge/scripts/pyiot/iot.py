...
'''
 This function makes a GET request to any webapp of given "spread_sheet_id" with any number of datapoints given through "data_points_dict_str" string
 ex: data_points_dict_str = "{ 'turtle_x': 10, 'turtle_y': 10, 'turtle_theta': 2}" pushes 10 to turtle_x and turtle_y column and 2 to
 turtle_theta column in this format there could be any number of data points
'''
