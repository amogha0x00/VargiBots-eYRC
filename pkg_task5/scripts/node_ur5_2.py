...
def main():
	...
	ur5_2.moveit_hard_play_planned_path_from_file(ur5_2._file_path, 'allZeros_to_home.yaml', 3)
	...
	while not rospy.is_shutdown() and i < 9:
		...
		ur5_2.moveit_hard_play_planned_path_from_file(ur5_2._file_path, '{}Bin_to_home.yaml'.format(pkg_color), 3)
		i += 1
